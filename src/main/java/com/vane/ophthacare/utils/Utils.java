...
public class Utils {
	...
	// YY: 2 chiffres de l'année de naissance, X: une lettres aléatoire et DD: 2
	// chiffres du jour de naissance
	public static String codePatient(String firstName, String lastName, String year) {
		...
		logger.info("End Calcul codePatient: Patient " + firstName + " " + lastName + " avec le code d'enregistrement: "
				+ code.toUpperCase());
	...
	// Où NNN: code profession, PP: 3 lettre du nom et prénom, DD: 2 chiffres du
	// jour de naissance
	public static String matriculeMedecin(List<ProfessionMedecin> professionMedecinList, String professionMedecin,
			String nomMedecin, String prenomMedecin, String dateNaisMedecin) {
		...
		logger.info("End Calcul matriculeMedecin: Médedcin " + nomMedecin + " " + prenomMedecin
				+ " avec le matricule d'enregistrement: " + matriculeMedecin.toUpperCase());

...
public class SheetSpecialiste extends SheetInterface {
	...
	private Class classForMethod = Specialiste.class;
	private Workbook workbook;
	private List<Specialiste> medecins;
	...
	public SheetSpecialiste () { super ();}
	
	public SheetSpecialiste (Workbook workbook, List<Specialiste> medecinList) {
	...
	public void startingPopulate(Sheet sheet) {
		...
		for(Specialiste medecin: medecins) {
